...
func NewGameplay(engineCtx *engine.Context) view.View {
	...
	updateSystemManager.Add(&playerMovementSystem{Context: engineCtx, eventManager: eventManager, playerCollection: playerCollection, physicsComponentManager: physicsComponentManager, healthComponentManager: healthComponentManager}, 0)
	...
	updateSystemManager.Add(&interactionSystem{Context: engineCtx, playerCollection: playerCollection, physicsComponentManager: physicsComponentManager, interactionComponentManager: interactionComponentManager, healthComponentManager: healthComponentManager}, 0)
	updateSystemManager.Add(NewHealthSystem(engineCtx, eventManager, playerCollection, healthComponentManager), 0)
	...
	renderSystemManager.Add(&playerRenderSystem{Context: engineCtx, playerCollection: playerCollection, physicsComponentManager: physicsComponentManager, interactionComponentManager: interactionComponentManager, healthComponentManager: healthComponentManager}, 2)
	...
	renderSystemManager.Add(&interactionRenderSystem{Context: engineCtx, playerCollection: playerCollection, physicsComponentManager: physicsComponentManager, interactionComponentManager: interactionComponentManager, healthComponentManager: healthComponentManager}, 5)

	createPlayer(entityManager, tagManager, groupManager, physicsComponentManager, interactionComponentManager, healthComponentManager)
